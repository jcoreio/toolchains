...
const defaultLogFunctionProvider = level => level >= LOG_LEVEL_ERROR ? console.error : console.log; // eslint-disable-line no-console
...
const defaultLogProvider = (loggerPath, level, ...args) => {
