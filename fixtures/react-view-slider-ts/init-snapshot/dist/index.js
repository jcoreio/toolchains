...
var ViewSlider = /*#__PURE__*/function (_React$Component) {
  ...
  function ViewSlider() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderView", function (index) {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: prefixer(style),
        ref: function ref(c) {
          return _this.views[index] = c !== null && c !== void 0 ? c : undefined;
        }
      }, /*#__PURE__*/React.createElement("div", {
        style: prefixer(_objectSpread({
          width: '100%'
  ...
  (0, _createClass2["default"])(ViewSlider, [{
    ...
    value: function componentDidUpdate() {
      ...
      this.setState(_objectSpread(_objectSpread({}, this.state), finalNewState), function () {
