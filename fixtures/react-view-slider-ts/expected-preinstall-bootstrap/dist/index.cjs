...
var defaultProps = {
  ...
  prefixer: _inlineStylePrefixer.prefix,
  style: {},
  viewportStyle: {},
  rtl: false,
  spacing: 1,
...
var ViewSlider = /*#__PURE__*/ (function (_React$Component) {
  ...
  function ViewSlider() {
    ...
    ;(0, _defineProperty2['default'])(
      ...
      function (childIndex) {
        ...
        if (prevActiveView == null)
          return childIndex === activeView ? 'in' : 'out'
    ...
    ;(0, _defineProperty2['default'])(
      ...
      function (index) {
        ...
        if (fillParent) {
          ...
          style.overflow = 'auto'
          if (rtl) style.right = ''.concat(index * spacing * 100, '%')
          else style.left = ''.concat(index * spacing * 100, '%')
        } else if (index > 0) {
          if (rtl) style.marginRight = ''.concat((spacing - 1) * 100, '%')
          else style.marginLeft = ''.concat((spacing - 1) * 100, '%')
    ...
    ;(0, _defineProperty2['default'])(
      ...
      'rootRef',
      function (node) {
        _this.root = node !== null && node !== void 0 ? node : undefined
    ...
    ;(0, _defineProperty2['default'])(
      ...
      'viewportRef',
      function (node) {
        _this.viewport = node !== null && node !== void 0 ? node : undefined
  ...
  ;(0, _createClass2['default'])(ViewSlider, [
    ...
    },
    {
      ...
      value: function componentDidUpdate() {
        ...
        this.setState(
          _objectSpread(_objectSpread({}, this.state), finalNewState),
          function () {
      ...
      value: function render() {
        var _this$getDefaultedPro6 = this.getDefaultedProps(),
          ...
          transitionTimingFunction =
            _this$getDefaultedPro6.transitionTimingFunction,
